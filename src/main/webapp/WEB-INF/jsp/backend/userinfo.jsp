...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    后台用户管理 <i class="fa fa-user"></i><small>${userSession.userName}
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
                                ...
                                <tbody>
                                    <tr role="row" class="odd">
                                        <td tabindex="0" class="sorting_1">${userSession.userCode}</td>
                                        ...
                                        <td>
                                            ...
                                            <c:if test="${userSession.userType == 3}">
                                                市场
                                            </c:if>
                                            <c:if test="${userSession.userType == 4}">
                                                运营
                                            </c:if>
                                            <c:if test="${userSession.userType == 5}">
                                                销售
                                            </c:if>
                                            </td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a  class="viewApp" href="/user/info/update"  data-toggle="tooltip" data-placement="top" title="" data-original-title="修改个人信息">修改</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div id="show" style="display: none">
                <div class="x_content">
                    <div class="clearfix"></div>
                    <form class="form-horizontal form-label-left" action="/user/info/updatepwd" method="post" onsubmit="return checkPwd()">
                        <input type="hidden" value="${userSession.id}" id="id" name="id">
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="devPassword" class="form-control col-md-7 col-xs-12"
                                       data-validate-length-range="20" data-validate-words="1" name="userPassword"   required="required"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="newDevPassword" class="form-control col-md-7 col-xs-12"
                                       data-validate-length-range="20" data-validate-words="1" name="newUserPassword"   required="required"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="newDevPassword2" class="form-control col-md-7 col-xs-12"
                                       data-validate-length-range="20" data-validate-words="1" name="newUserPassword2"   required="required"
    ...
    $(document).ready(function () {
        ...
        $("#devPassword").blur(function () {
            ...
            $.ajax({
                ...
                data:{id:$("#id").val(),userPassword:$("#devPassword").val()},
                datatype:"html",
